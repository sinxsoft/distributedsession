...
{
  private static final String __NEW_SESSION_ID = "org.storevm.newSessionId";
	...
	public String newSessionId(HttpServletRequest request, long created)
  {
    synchronized (this)
    {
      ...
      String newId = (String)request.getAttribute("org.storevm.newSessionId");
      if (newId != null) {
        return newId;
      }
      String id = null;
      ...
      {
        long r = this.weakRandom ? hashCode() ^ Runtime.getRuntime().freeMemory() ^ this.random.nextInt() ^ request.hashCode() << 32 : this.random.nextLong();
      ...
      request.setAttribute("org.storevm.newSessionId", id);
      return id;
    }
  }
}
